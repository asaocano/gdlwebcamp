        ...
        <li>
          <div class="tabla-precio">
            ...
            <div class="orden">
              ...
              <input type="number" min="0" id="pase-dos-dias" size="3" name="boletos[]" placeholder="0" />
            </div>
          </div>
        </li>
      </ul>
        ...
        <div class="extras">
          ...
          <div class="orden">
            <label for="etiquetas">Paquete de etiquetas $2
              <small> (HTML5, CSS3, JavaScript)</small></label>
          ...
          <div class="orden">
            ...
            <select id="regalo" name="regalo" required>
              ...
              <option value="3">--Libreta y plumas--</option>
            </select>
          </div>
